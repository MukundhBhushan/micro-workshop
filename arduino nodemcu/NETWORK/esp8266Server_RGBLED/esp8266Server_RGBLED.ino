...
const char* ssid = "Wifilink";         //Mention SSID
const char* password = "kmvgrp020";     //Mention Password
ESP8266WebServer server(80);
const int R = 5;                          // D1 of nodemcu
const int G = 2;                          // D3 of nodemcu
const int B = 4;                          // D2 of nodemcu
void handleRoot()
{
